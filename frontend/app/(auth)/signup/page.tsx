...
import { Sparkles, Loader2, Mail, Lock, User, CheckCircle2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-slate-900/80 border border-slate-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl z-10">
        {success ? (
          <div className="text-center py-6">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center w-full py-2.5 px-4 bg-slate-950 hover:bg-slate-900 border border-slate-800 rounded-xl text-sm font-medium text-slate-300 hover:text-white transition-all"
            >
              Back to Sign In
            </Link>
          </div>
