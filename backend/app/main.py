...
from app.routers import agent, auth, integrations, memory, onboarding, rag, sync, tasks, workspace
...
app.include_router(agent.router, prefix="/agent", tags=["LangGraph agents"])
